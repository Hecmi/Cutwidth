...
namespace CWP.Pruebas
{
    class CWPD
    {
        ...
        public CWPD(int MAXIMO_ITERACIONES)
        {
            this.ITERACION_ACTUAL = 0;
            this.MAXIMO_ITERACIONES = MAXIMO_ITERACIONES;
        }
        ...
        private Vertice[] getVerticesAdyacentes(int[] vertice)
        {
            ...
            for (int j = 0; j < adyacentes.Count; j++)
            {
                ...
                VERTICES[idx_u].peso = VERTICES[idx_u].grado - VERTICES[idx_u].offset;
        ...
        private Vertice seleccionarVerticeComplejidad(Vertice[] vertices_candidatos, int cantidad_evaluar)
        {
            ...
            for (int i = 0; i < cantidad_evaluar; i++)
            {
                ...
                VERTICES[idx_v].complejidad_adyacente = calcularGradoComplejidad(vertices_candidatos[i].vertice);
        ...
        private void calcularAnchoCorte()
        {
            ...
            for (int i = 0; i < NUMERO_VERTICES; i++)
            {
                this.MUESTRA_EVALUADA[0, i] = ordenamiento[i];
            }
            this.CORTES_MUESTRA[0] = corteMaximo;
        }
